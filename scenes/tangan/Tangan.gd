...
@onready var hand_sprite_unhold = preload("res://assets/3.8 - Minigame vending machine/tangan1.png")
@onready var hand_sprite_hold = preload("res://assets/3.8 - Minigame vending machine/tangan2.png")
